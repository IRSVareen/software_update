...
const updateLogs = async (req, res) => {
    try {
        ...
        const updatedLogs = await Logs.findOneAndUpdate({ deviceId, _id: logId }, { description, softwareVersion, updateStatus, startTime: createDateTime(startTime), endTime: createDateTime(endTime), date: formattedDate }, { new: true })
